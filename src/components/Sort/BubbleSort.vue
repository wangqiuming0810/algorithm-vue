<template>
  <div>
    <baseDiv ref="base" :code-data-list="codeDataList" :level-list="levelList" :option="option" :title="title">
      ...
      <el-form slot="change-dialog-div">
        <el-form-item label="数组个数:" label-width="80px">
          <el-input v-model.number="Player.len" placeholder="数组长度"/>
        </el-form-item>
        <el-form-item label="最小值:" label-width="80px">
          <el-input v-model.number="Player.min" placeholder="最小数"/>
        </el-form-item>
        <el-form-item label="最大值:" label-width="80px">
          <el-input v-model.number="Player.max" placeholder="最大数"/>
        </el-form-item>
      </el-form>
      <el-form slot="add-dialog-div">
        <el-form-item label="数组:" label-width="60px">
          <el-input v-model="dataString" placeholder="数组" type="textarea"/>
        </el-form-item>
      </el-form>
    </baseDiv>
  </div>
...
export default {
  ...
  methods: {
    ...
    moveCursor() {
      ...
      let i = this.Player.moveCursor.i
      let j = this.Player.moveCursor.j
      const innerLoop = () => {
