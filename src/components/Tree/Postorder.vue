<template>
  <div>
    <baseDiv ref="base" :codeDataList="codeDataList" :display="display" :levelList="levelList" :option="option"
             :title="title"
    >
      ...
      <div slot="add-dialog-div">
        <el-row :gutter="30">
          <el-col :lg="21" :md="24" :sm="24" :xl="21" :xs="24" class="build-canvas">
            <!-- <canvas  width="500" height="300"></canvas> -->
            <canvasDiv ref="canvas"></canvasDiv>
          </el-col>
          <el-col :lg="3" :md="24" :sm="24" :xl="3" :xs="24" class="build-box">
            <el-button class="build-btn" plain size="mini" type="primary" @click="buildTree">自动建树</el-button>
          </el-col>
        </el-row>
      </div>
    </baseDiv>
  ...
  methods: {
    ...
    buildTree() {
      ...
      const {
        root,
        str
      } = Tree.randomCreateTree(20, this.randomString)
      this.treeData = root
