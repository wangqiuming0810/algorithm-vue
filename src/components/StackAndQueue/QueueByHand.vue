  ...
  <div>
    <baseDiv ref="base" :codeDataList="codeDataList" :levelList="levelList" :option="option" :title="title">
      ...
      <div slot="button-group">
        <el-button-group>
          <el-button icon="el-icon-plus" type="warning" @click="push">入队列</el-button>
          <el-button icon="el-icon-setting" type="info" @click="dialogVisible=true"></el-button>
          <el-button icon="el-icon-delete" type="primary" @click="pop">出队列</el-button>
        </el-button-group>
      </div>
    </baseDiv>
    <el-dialog
