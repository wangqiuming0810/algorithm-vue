    ...
    <el-container>
                ...
                >
                  <div class="radio-div">
                    <el-radio-group v-model="language" size="mini" @change="changeDataCode">
                      <el-radio-button border label="0" @click="changeDataCode">C</el-radio-button>
                      <el-radio-button border label="1">C++</el-radio-button>
                      <el-radio-button border label="2">Java</el-radio-button>
                    </el-radio-group>
                  </div>
                </el-col>
                <el-col
      ...
      <el-footer style="height: auto">
        <el-card shadow="hover">
          <el-row :gutter="10">
            <el-col :lg="3" :md="3" :sm="4" :xl="2" :xs="0">
              <div class="span-div">播放速度:</div>
            </el-col>
            <el-col :lg="9" :md="21" :sm="20" :xl="10" :xs="24">
...
const {
  mode,
  theme
} = require('@/json/codeTheme.json')// 获取代码风格配置文件
export default {
  name: 'AppContainer',
  props: {
    // 配置项
