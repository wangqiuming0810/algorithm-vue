      ...
      <template #change>
        ...
        >
          <el-form-item label="当前数据">
            <el-input :value="arr.toString()" disabled/>
          </el-form-item>
          <el-form-item
            label="输入数据"
            prop="arrStr"
          >
            <el-row :gutter="10">
              <el-col
                ...
                :xs="20"
              >
                <el-input v-model="changeForm.arrStr"/>
              </el-col>
              <el-col
                :lg="10"
                :md="10"
              ...
              >
                <el-button-group>
                  <el-button size="mini" type="primary" @click="random">随机</el-button>
                  <el-button size="mini" type="warning" @click="resetForm('changeForm')">重置</el-button>
                </el-button-group>
              </el-col>
            </el-row>
          </el-form-item>
