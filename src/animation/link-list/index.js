        ...
        if (preItem) {
          ...
          if (i % rowLength === 0) {
            points.push(
              prePoints,
              {
                x: prePoints.x + 2 * ItemLin2Width,
                y: prePoints.y
              },
              {
                x: prePoints.x + 2 * ItemLin2Width,
                y: prePoints.y + ySpace / 2
              },
              {
                x: -width - ItemLin2Width / 2,
                y: prePoints.y + ySpace / 2
              },
              {
                x: -width - ItemLin2Width / 2,
                y: prePoints.y + ySpace
              },
              {
                x: x * xSpace - (width + ItemLin2Width) / 2,
                y: y * ySpace
              }
            )
          } else {
